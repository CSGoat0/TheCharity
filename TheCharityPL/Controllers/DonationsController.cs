...
namespace TheCharityPL.Controllers
{
    ...
    public class DonationsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(int id, [FromBody] UpdateDonationDto dto)
        {
            ...
            var result = await _service.UpdateDonationAsync(id, dto);
            return HandleResponse(result, notFoundOnFailure: true);
        }
        ...
        {
            var result = await _service.RestoreDonationAsync(id);
            return HandleResponse(result, notFoundOnFailure: true);
        }
        ...
        {
            var result = await _service.GetUserLastDonationDateAsync(userId);
        ...
        public async Task<IActionResult> GetCampaignsDonatedByUser([FromQuery] PaginationParametersDto parametersDto, string userId)
        ...
        public async Task<IActionResult> TransferDonations(
            ...
            => Ok(await _service.TransferDonationsToCampaignAsync(from, to));
        ...
        public async Task<IActionResult> DeleteOldDonations([FromQuery] int daysOld = 365)
            => Ok(await _service.DeleteOldDonationsAsync(daysOld));
